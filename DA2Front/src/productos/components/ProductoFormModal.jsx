...
export function ProductoFormModal({
  ...
  const comercioNombre = useMemo(() => {
    return (
      ...
      comercios.find((comercio) => comercio.id === Number(form.comercioId))
        ?.nombreComercial ??
      ""
    );
      ...
      <div className="producto-modal" role="dialog" aria-modal="true">
        ...
        <form className="producto-form" onSubmit={handleSubmit}>
          ...
          <div className="producto-modal-actions">
            <button
              type="button"
              className="producto-button producto-button-ghost"
              onClick={onClose}
            >
              Cancelar
            </button>
            <button
              type="submit"
              className="producto-button producto-button-primary"
              disabled={submitting}
            >
