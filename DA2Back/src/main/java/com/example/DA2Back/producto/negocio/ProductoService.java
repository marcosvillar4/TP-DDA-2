...
public class ProductoService implements IProductoService {
    ...
    private Comercio resolverComercio(Long comercioId) {
        ...
        try {
            return comercioService.obtenerEntidadPorId(comercioId);
    ...
    private boolean esViolacionSkuDuplicado(DataIntegrityViolationException ex) {
        ...
        while (actual != null) {
            if (actual instanceof ConstraintViolationException constraintViolation) {
                ...
                if (esConstraintProductoSku(constraintName)) {
                    return true;
                }
            }

            if (esConstraintProductoSku(actual.getMessage())) {
                return true;
            }
    ...
    private boolean esConstraintProductoSku(String valor) {

        return valor != null
                && valor.toLowerCase().contains("uk_producto_comercio_sku");
    }
}
